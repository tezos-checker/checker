...
let liquidation_reward_percentage : FixedPoint.t =
  FixedPoint.of_ratio_floor (make_ratio (Ligo.int_from_literal "1") (Ligo.int_from_literal "1000")) (* 0.001 *)
...
let min_lot_auction_queue_fraction : FixedPoint.t =
  FixedPoint.of_ratio_floor (make_ratio (Ligo.int_from_literal "5") (Ligo.int_from_literal "100"))

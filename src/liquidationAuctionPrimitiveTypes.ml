...
type avl_ptr = AVLPtr of ptr [@@deriving show]

type leaf_ptr = LeafPtr of ptr [@@deriving show]
...
type liquidation_auction_id = avl_ptr [@@deriving show]

type bid = { address : Ligo.address; kit : kit } [@@deriving show]
...
type leaf = { value : liquidation_slice; parent : ptr } [@@deriving show]

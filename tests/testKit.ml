...
let suite =
  "KitTests"
  >::: [
         ( "kit arithmetic" >:: fun _ ->
           (* scaling factor (int) *)
           assert_int_equal ~expected:kit_scaling_factor_int
             ~real:
               (Common.pow_int_nat
           ...
           assert_kit_equal
             ...
             ~real:
               (kit_add
                  ...
                  (kit_of_mukit (Ligo.nat_from_literal "3_000_000n")));
           ...
           assert_kit_equal
             ...
             ~real:
               (kit_scale
                  (kit_of_mukit (Ligo.nat_from_literal "5_123_467n"))
                  (fixedpoint_of_ratio_floor
                     (ratio_of_int (Ligo.int_from_literal "3"))));
           ...
           (* show *)
           assert_string_equal ~expected:"50309951mukit"
             ~real:

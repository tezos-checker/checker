...
let suite =
  ...
  >::: [
         ( "ctez arithmetic" >:: fun _ ->
           ...
           assert_ctez_equal
             ...
             ~real:
               (ctez_add
                  ...
                  (ctez_of_muctez (Ligo.nat_from_literal "3_000_000n")));
           ...
           (* show *)
           assert_string_equal ~expected:"50309951muctez"
             ~real:
               (show_ctez
                  (ctez_of_muctez (Ligo.nat_from_literal "50_309_951n"))) );
       ]

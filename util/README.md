...
```
tezos-client originate contract mock_oracle transferring 0 from bob running mock_oracle.tz --init '(Pair "tz1aSkwEot3L2kmUvcoxzjMomb9mvBNuzFK6" (Pair 1000000 1000000))'
```

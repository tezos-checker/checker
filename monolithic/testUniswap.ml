...
let suite =
  "Uniswap tests" >::: [
    ...
    (fun _ ->
       ...
       let expected_returned_tez = Tez.of_float 1.663333 in
       let expected_returned_kit = Kit.of_float 0.000000 in
       let expected_updated_uniswap : Uniswap.t =
         { tez = Tez.of_float 8.336667;
           kit = Kit.of_float 6.000000;
           total_liquidity_tokens = 1;
         } in
       let returned_tez, returned_kit, updated_uniswap = Uniswap.sell_kit uniswap (Kit.of_float 1.0) in
    ...
    (fun _ ->
       ...
       let expected_returned_tez = Tez.of_float 0.000000 in
       let expected_returned_kit = Kit.of_float 5.605759 in
       let expected_updated_uniswap : Uniswap.t =
         { tez = Tez.of_float 28.336667;
           kit = Kit.of_float 20.394241;
           total_liquidity_tokens = 3;
         } in
       let returned_liquidity, returned_tez, returned_kit, updated_uniswap =
         Uniswap.buy_liquidity uniswap (Tez.of_float 20.0) (Kit.of_float 20.0) in
